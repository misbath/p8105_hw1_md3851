...
`r nrow(example2_df)` rows. 

The mean of the sample is `r mean(pull(example2_df, x))`.

The median of the sample is `r median(pull(example2_df, x))`.

The standard deviation of the sample is `r sd(pull(example2_df, x))`.
